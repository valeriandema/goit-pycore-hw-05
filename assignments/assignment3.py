...
def load_logs(path: str) -> List[Dict[str, str]]:
    """
    Завантажує логи з файлу і повертає список словників з ключами datetime, level, message.
    """
    try:
...
def parse_log_line(line: str) -> Dict[str, str]:
    """
    Парсить рядок логу і повертає словник з ключами datetime, level, message.
    """
...
def filter_logs_by_level(logs: List[Dict[str, str]], level: str) -> List[Dict[str, str]]:
    """
    Фільтрує логи за рівнем логування з використанням функціонального програмування.
    """
...
def display_logs_for_level(logs: List[Dict[str, str]], level: str) -> None:
    """
    Виводить детальну інформацію для всіх записів певного рівня логування.
    """
...
def main():
    """
    Головна функція для обробки аргументів командного рядка та виконання аналізу логів.
    """
    if len(sys.argv) < 2:
        print("Використання: python assignment3.py <шлях_до_файлу_логів> [рівень_логування]")
